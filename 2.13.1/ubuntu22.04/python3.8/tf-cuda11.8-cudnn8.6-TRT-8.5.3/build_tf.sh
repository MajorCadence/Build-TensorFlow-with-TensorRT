...
echo "Building TensorFlow 2.13.1 with TensorRT for Python 3.8 on Ubuntu 22.04"
...
export PYTHON_LIB_PATH=/root/.pyenv/versions/tf-build/lib/python3.8/site-packages
