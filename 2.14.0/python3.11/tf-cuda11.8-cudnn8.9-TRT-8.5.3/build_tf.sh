...
echo "Building TensorFlow 2.14.1 with TensorRT for Python 3.11 on Rocky 8..."

pip install -r requirements_lock_3_11.txt

export PYTHON_BIN_PATH=/root/.pyenv/versions/tf-build/bin/python3
export PYTHON_LIB_PATH=/root/.pyenv/versions/tf-build/lib/python3.11/site-packages
...
export GCC_HOST_COMPILER_PATH=/opt/rh/gcc-toolset-11/root/usr/bin/gcc
